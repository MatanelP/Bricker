...
public class BallCollisionCountdownAgent extends GameObject {
    private final int ballInitialCollisionValue;
    ...
    public BallCollisionCountdownAgent(Ball ball,
        ...
        this.ballInitialCollisionValue = ball.getCollisionCount();
    }
    ...
    public void update(float deltaTime) {
        ...
        if (ball.getCollisionCount() >= countDownValue + ballInitialCollisionValue) {
